...
//CounterTextbox livesText = CounterTextbox(NA_TEXT, Constants::Game::LIVES, 15, 15, 3);
...
void loseLife() {
    ...
    //livesText.setText(Player::lifeCount);
}
...
SDLGraphicsProgram::SDLGraphicsProgram() :
        ...
        //Initialize TTF
            ...
            success = false;
    			...
    			gWindow = SDL_CreateWindow("Lab",
										   ...
										   SDL_WINDOWPOS_UNDEFINED,
                                           Constants::Game::SCREEN_UNIT_WIDTH * Constants::Game::UNIT,
                                           Constants::Game::SCREEN_UNIT_HEIGHT * Constants::Game::UNIT,
										   SDL_WINDOW_SHOWN);
    ...
    this->backgroundMusicFile = Constants::SFXPath::MUSIC;
    backgroundMusic = resourceManager->getMusicResource(this->backgroundMusicFile);

    //Load background image
    this->backgroundImageFile = Constants::TexturePath::BACKGROUND;
